...
const ProductItemAdminDetailed = ({ img }) => {
  return (
      ...
      <div className="product-item cart-item mt-3 d-flex">
        ...
        >
          ...
          <button className="quick-view-btn">
            <Icon icon="iconamoon:eye" color="#666" width="22" height="22" />
          </button>
        </div>
        <Card.Body className="cart-info d-flex flex-column justify-content-between py-1 pb-2 px-3">
          ...
          <Card.Title className="text-start product-desc text-success">
            Card Title in here we put the descriptio of the product so in here
            we can do this of the end
          </Card.Title>
          <div className="d-flex mt-2 gap-5">
            <div className="color">
              <div className="fw-bold fs-6">
                Color: <span className="fw-semibold">Black</span>
              </div>
              <div
              ...
              >
                ...
                ></input>
                <label
                  class="yello color-item rounded-circle bg-warning"
                  for="btnradio4"
                ></label>
                ...
                ></input>
                <label
                  class="yello color-item rounded-circle bg-danger"
                  for="btnradio5"
                ></label>
                ...
                ></input>
                <label
                  class="yello color-item rounded-circle bg-dark"
                  for="btnradio6"
                ></label>
              </div>
              if we add some thing in hre we should add interesting thisn
            </div>
            <div className="size ">
              <div className="fw-bold fs-6">
                Size : <span className="fw-semibold">XS</span>
              </div>
              <div
                class="gap-2 mt-2 d-flex"
                role="group"
          ...
          <div className="d-flex mt-3 align-items-center justify-content-between">
            <div className=" d-flex gap-3  align-items-center justify-content-center ">
              <button className="btn btn-outline-success rounded-circle btn-quantity">
                -
              </button>
              <div>15</div>
              <button className="btn btn-outline-success rounded-circle btn-quantity">
...
export default ProductItemAdminDetailed;
