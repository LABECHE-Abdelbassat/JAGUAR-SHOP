  ...
  return (
    <div className="cart-flow">
      <div className="product-item cart-item mt-3 d-flex">
        <div
          className="p-relative card-img-cart-item-order"
          style={{ position: "relative", overflow: "hidden" }}
        >
          <Card.Img
            className="card-img-cart-item img-fluid"
        ...
        <Card.Body className="cart-info d-flex flex-column justify-content-between py-1 pb-2 px-3">
          ...
          <div className="d-flex mt-2 gap-5">
            <div className="color">
              <div className="fw-bold fs-6">
                Color : <span className="fw-semibold">{data?.color}</span>
              </div>
            </div>
          ...
          <div className="d-flex mt-3 align-items-center justify-content-between">
            <div className="fw-bold fs-6">
              Quantity : <span className="fw-semibold">{data?.quantity}</span>
            </div>
            <div className="fw-bold fs-5">
              {" "}
              <span className="fw-semibold">{data?.price}$</span>
            </div>
          </div>
        </Card.Body>
      </div>
...
export default OrdersProductItem;
